...
class LoginManager(object):
    ...
    def __init__(self, app=None, add_context_processor=True):
        ...
        #: The message to flash when a user is redirected to the auth page.
        self.login_message = LOGIN_MESSAGE

        #: The message category to flash when a user is redirected to the auth
        #: page.
    ...
    def unauthorized(self):
        ...
        be called. Otherwise, it will take the following actions:
            ...
            - If the app is using blueprints find the auth view for
              the current blueprint using `blueprint_login_views`. If the app
              is not using blueprints or the auth view for the current
              blueprint is not specified use the value of `login_view`.

            - Redirect the user to the auth view. (The page they were
            ...
            if user_id is None:
                ...
                if self.user_callback is None:
                    raise Exception(
                        ...
                        "https://flask-auth.readthedocs.io/"
