...
def send_login():
    """View function that sends auth instructions for passwordless auth"""
...
def token_login(token):
    """View function that handles passwordless auth via a token"""
